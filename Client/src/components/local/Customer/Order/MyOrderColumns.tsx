...
export const columns: ColumnDef<IOrder>[] = [
    ...
    header: () => {
      return (
        <div className="flex select-none items-center">
          <span className="flex cursor-pointer text-white">Customer ID</span>
        </div>
      )
    },
    cell: (info) => {
  ...
  },
  {
    ...
    header: () => {
      return (
        <div className="flex select-none items-center">
          <span className="flex cursor-pointer text-white">Phone</span>
        </div>
      )
    },
    cell: (info) => {
    ...
    header: ({ column }) => {
      return (
        <div
          ...
          onClick={() => column.toggleSorting(column.getIsSorted() === "asc")}
        >
          <span className="flex cursor-pointer text-white">Created At</span>
          <ArrowUpDown className="ml-2 cursor-pointer text-white" size={16} />
        </div>
      )
    },
